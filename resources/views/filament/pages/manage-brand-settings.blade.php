<x-filament-panels::page>
    @php
        ...
        $storeUrl = $brand ? brand_page_url($brand->slug) : null;
    @endphp
        ...
        <div class="mb-6 rounded-xl border border-primary-200 bg-primary-50 p-4 dark:border-primary-800 dark:bg-primary-950/40"
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="min-w-0">
                    ...
                    <p class="mt-1 text-sm font-semibold text-gray-700 dark:text-gray-200 break-all" dir="ltr">{{ $storeUrl }}</p>
                ...
                <div class="flex flex-wrap gap-2 shrink-0">
                    ...
                    <x-filament::button tag="a" href="{{ $storeUrl }}" target="_blank" icon="heroicon-m-arrow-top-right-on-square">
                        فتح المتجر
                    </x-filament::button>
                </div>
            </div>
