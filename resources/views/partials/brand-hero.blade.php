@props(['brand', 'compact' => false, 'productCount' => 0, 'brandStats' => null, 'showActions' => true, 'seo' => []])
  ...
  <div class="brand-hero__inner">
    <div class="brand-hero__glass brand-hero-enter">
      <div class="brand-hero__top">
        ...
        <div class="brand-hero__share brand-hero-enter brand-hero-enter--3">
          @include('partials.brand-share-sheet', ['brand' => $brand, 'seo' => $seo])
        </div>
      </div>
      ...
      @if($showActions && !$compact)
        <div class="brand-hero__actions brand-hero-enter brand-hero-enter--4">
          ...
          @if($waHref)
            <a href="{{ $waHref }}" target="_blank" rel="noopener" class="brand-hero__btn brand-hero__btn--wa">
